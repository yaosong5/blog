...
![](http://img.gangtieguo.cn/0069RVTdly1fu9a7zzwdrj31540lvjtv.jpg)
...
![](http://img.gangtieguo.cn/0069RVTdly1fu9abi7beaj312e04agng.jpg)

每个partion(目录)相当于一个巨型文件被平均分配到多个大小相等segment(段)数据文件中。**但每个段****segmentfile****消息数量不一定相等**，这种特性方便oldsegment file快速被删除。默认保留7天的数据。

![](http://img.gangtieguo.cn/0069RVTdly1fu9ajs8d4dj30rs0dgwj3.jpg)

每个partiton只需要支持顺序读写就行了，segment文件生命周期由服务端配置参数决定。（什么时候创建，什么时候删除）

![](http://img.gangtieguo.cn/0069RVTdly1fu9ajsxr9bj30tt0ektai.jpg)

### Kafka Partition Segment

Segment file组成：由2大部分组成，分别为index file和data file，此2个文件一一对应，成对出现，后缀".index"和“.log”分别表示为segment索引文件、数据文件。

![](http://img.gangtieguo.cn/0069RVTdly1fu9ai5p7amj30nv0f0gre.jpg)
...
![](http://img.gangtieguo.cn/0069RVTdly1fu9ai52pxmj30sx0hetdm.jpg)
